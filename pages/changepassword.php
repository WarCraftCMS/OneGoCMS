                    ...
                    <div class="mt-2">
                        <form method="post" action="/?page=changepassword">
                            <input type="hidden" name="xc_cv2" value="92d546f46ca9c2343142c8b80ed5de73">                        
                                <div class="divider">Изменить пароль учетной записи</div>
                        <div class="mt-2">
                            <label class="input input-bordered flex items-center gap-2 bg-zinc-900/40">
                                <span class="mr-2 text-center">Текущий пароль</span>
                                <input type="text" id="old_password" name="old_password" class="grow w-48 md:w-auto" placeholder="Текущий пароль" aria-required="true">
                            </label>
                        </div>
                        <div class="mt-2">
                            <label class="input input-bordered flex items-center gap-2 bg-zinc-900/40">
                                <span class="mr-2 text-center">Новый пароль</span>
                                <input type="password" id="new_password" name="new_password" class="grow w-48 md:w-auto" placeholder="Новый пароль" aria-required="true">
                            </label>
                        </div>
                        <div class="mt-2">
                            <label class="input input-bordered flex items-center gap-2 bg-zinc-900/40">
                                <span class="mr-2 text-center">Повторите пароль</span>
                                <input type="password" id="confirm_password" name="confirm_password" class="grow w-48 md:w-auto" placeholder="Повторите новый пароль"  aria-required="true">
                            </label>
                        </div>
                        <div class="mx-auto text-center">
                            <input type="submit" class="btn mx-auto bg-blue-500/70 hover:bg-blue-700 text-white mt-2"
                                value="Изменить" name="submit">      
                        </div>
                        </form>
                  </div>
                </div>
