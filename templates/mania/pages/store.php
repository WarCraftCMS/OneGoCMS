    ...
    <div class="content inner-content flex-ss">
            ...
            <div>
                ...
                <table>
                    ...
                    <tr><td><li>При покупке Подписки GG Prime нужно перезайти в игру!</li></td></tr>
                </table>
                </center> 
                <br>
            </div>
...
<?php foreach ($items as $item) : ?>
                <div class="item flex-cs">
                    ...
                    <a href="http://wotlk.cavernoftime.com/item=<?= htmlspecialchars($item['item_id']) ?>" class="name">
